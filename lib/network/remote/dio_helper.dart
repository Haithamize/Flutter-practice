...
class DioHelper {
  ...
  static init() {
    //5alet de static 3shan anadiha fl main awl ma el app yft7 3shan a3ml object ml dio bta3i
    dio = Dio(BaseOptions(
  ...
  static Future<Response> getData(
    ...
    //el query hna el mfrod enha Map<String,dynamic> fa lw 3ayz a3mlha msh dynamic lazm a5liha b nfs el se8a w mktpsh Map bs 3shan hydrb error
    dio.options.headers = {
      'lang': lang,
      'content-type': 'application/json;charset=UTF-8',
      'authorization': 'Bearer $token',
      //sa3at ha7tag el token m3aya zy lw hgip el profile bta3 el user wl manzar eli ana 3mlo da m3nah en lw fe kema 7otaha w lw mfish 7otlha null kda ''
    };
  ...
  static Future<Response> post({
    ...
    dynamic query,
    Map<String, dynamic>
        data, //tb3n lazm ab3t data 3shan b3ml login wl data de htb2a f shakl map key and value of the email and password
    String token,
    String lang = 'ar',
  }) async {
    dio.options.headers = {
      ...
      'content-type': 'application/json;charset=UTF-8',
      'authorization': 'Bearer $token',
      //sa3at ha7tag el token m3aya zy lw hgip el profile bta3 el user
    };
